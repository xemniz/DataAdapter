...
public class AsyncListDiffer<T> {
    ...
    public AsyncListDiffer(@NonNull RecyclerView.Adapter adapter,
        ...
        mAdapter = adapter;
        @NonNull ListUpdateCallback listUpdateCallback = new AdapterListUpdateCallback(adapter);
        @NonNull AsyncDifferConfig<T> config = new AsyncDifferConfig.Builder<>(diffCallback).build();
    ...
    public void submitList(@Nullable final List<T> newList) {
        submitList(newList, null, false);
    }


    public void submitListSync(@Nullable final List<T> newList) {
        submitList(newList, null, true);
    }
    ...
    public void submitList(@Nullable final List<T> newList,
        ...
        mConfig.getBackgroundThreadExecutor().execute(() -> {
            final DiffUtil.DiffResult result = getResult(newList, oldList);
    ...
    @NotNull
    private DiffUtil.DiffResult getResult(@NotNull List<T> newList, List<T> oldList) {
